...
then
    ...
    ## step 1 - parallel
    pbspro_script=HiCPro_step1_${JOB_NAME}.sh
...
then
    ...
    pbspro_script_s2=HiCPro_step2_${JOB_NAME}.sh
    cat > ${pbspro_script_s2} <<EOF
#!/bin/bash
